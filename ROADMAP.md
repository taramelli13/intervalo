...
**Estado:** protocolo clínico fechado na versão 1.3.0. Nenhuma linha de app escrita ainda — por decisão, não por atraso ([D-005](DECISOES.md)).

---

## Fase 0 — Protocolo clínico ✅
...
- [ ] Modo sem números como estado de primeira classe do modelo, não como flag de exibição
- [ ] Decidir stack — segue em aberto de propósito
...
- [ ] Calibrar o corte de 45 do TFEQ com dado próprio — a suspeita é que ele não separe nada neste público
